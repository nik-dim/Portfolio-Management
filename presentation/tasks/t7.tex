...
\begin{frame}
    ...
    \begin{equation*}
        ...
        \end{array}    \right\} \pause\implies \epsilon_{naive}: y = \underbrace{\frac{r_{\text{naive}}-r_f}{\sigma_{\text{naive}}}}_{\text{naive Sharpe Ratio}}\cdot x + r_f
    \end{equation*}
...
\begin{frame}
    \frametitle{Naive CAL}

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{../report/media/Naive_CAL_and_EF.png}
        \captionsetup{width=0.7\linewidth}
