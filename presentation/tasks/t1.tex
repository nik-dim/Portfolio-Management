...
%         \begin{itemize}
%            \item fix contents (example: Intro, Theory, Results)
%           \item better resolution on images
%      \end{itemize}
%\end{alertblock}
%\end{frame}
...
\begin{frame}
    ...
    % \includepdf[pages=1]{../report/media/q.pdf}
    % \includegraphics[page=1,width=0.5\paperwidth]{../report/media/q.pdf}
    
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \includegraphics[page=4,width=0.5\paperwidth]{../report/media/InvestorQuestionnaire.pdf}
        \end{column}
        \pause
        \begin{column}{0.5\textwidth}  %%<--- here
            \begin{center}
                \begin{alertblock}{Asset Allocation}
                    \begin{itemize}
                        \item 70\% Stocks
                        \item 20\% Bonds
                        \item 10\% Commodities
