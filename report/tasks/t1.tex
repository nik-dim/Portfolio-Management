...
\begin{itemize}
	...
	\item Risk-profile: Moderately Aggressive
...
Based on our risk tolerance profile (see Appendix) and aim for long-term capital growth, the portfolio asset allocation will be 24\% on risk-free assets and 76\% on a risky portfolio with the following mix:
\begin{itemize}
	\item 70\% Stocks
	\item 20\% Bonds
	\item 10\% Commodities
...
\paragraph*{Equity}
Equities are the main investment instrument of our portfolio. As moderately aggressive investors, we mainly prefer stocks of companies with large market capitalization that are highlighted for growth potential. A total of 6 stocks are selected, with the following characteristics: 
\begin{itemize}
...
A more elaborate analysis of the final selected assets is performed in Section \ref{sec_selection}.
