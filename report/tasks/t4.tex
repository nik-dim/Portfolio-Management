...
A summary of the descriptive statistics of the selected asset's daily returns is given in the table below (in percentage values). A histogram for these statistics is presented in Figure 5.
