...
We can conclude that holding the overall portfolio is the best choice for us, since it not only offers superior returns compared to the market index, but does so with a higher Sharpe Ratio. The overall portfolio's \( \alpha \) was approximately 20\%, indicating that the portfolio exceeded return expectations and that some of the holding securities are under-valued.
