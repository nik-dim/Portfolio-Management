...
Let \(z\) be the proportion of funds allocated to the optimal risky portfolio. Then \((1-z)\) is the proportion allocated to risk-free assets. Investors calculate the optimal \(z\) by maximizing their utility. Expressed as a function of z, utility is given by the equation below:

enter utility equation here

Therefore the optimal \(z\) that maximizes utility is:

enter z* equation here
